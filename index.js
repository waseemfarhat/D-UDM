// ===== INTRO SPEECH =====
const speeches = [
  { title: "WELCOME!", text: "Hi there! 👋 I'm your digital marketing guide. Let me show you how US Digital Marketing Services can transform your business!" },
  { title: "LOCAL BUSINESS HERO", text: "🏪 Whether you run a clinic, gym, salon, mall, restaurant, or general store — we have the perfect strategy to get more customers through your door every single day." },
  { title: "GOOGLE ADS", text: "🔍 When someone searches for your service on Google, YOUR business appears first. We run powerful Google Ads that put you at the top of search results — right when customers are ready to buy!" },
  { title: "INSTAGRAM & FACEBOOK ADS", text: "📱 We create stunning Instagram and Facebook ad campaigns that stop people mid-scroll. Beautiful visuals + laser-targeted audiences = more followers, more calls, more sales!" },
  { title: "YOUTUBE ADS", text: "▶️ YouTube has 2 billion users! We place your video ads in front of people actively searching for your products. Every view is a potential customer discovering your brand." },
  { title: "REAL RESULTS", text: "📊 We've generated 163 million+ leads, reached 974 million+ people, and delivered 863% average ROI. Your business deserves growth like this!" },
  { title: "100× GROWTH AWAITS", text: "🚀 Ready to multiply your business 100 times? Plans start from just ₹25,000/month. Contact Utkarsh Singh at +91 9630715686. Let's build your digital success story — starting TODAY!" }
];
...
(function(){
  var svcData = {
    'Digital Marketing':{tag:'Full-Funnel Growth',desc:'We run complete Google, Instagram, YouTube & Facebook campaigns 24/7 — generating qualified leads and scaling your brand to millions of potential customers.',wa:'Digital Marketing'},
    'Medical Clinics':{tag:'Healthcare Advertising',desc:'Get more appointment bookings through targeted Google Ads and local SEO. We put your clinic first exactly when patients are actively searching for care.',wa:'Medical Clinic'},
    'Real Estate':{tag:'Property Lead Generation',desc:'Hyper-local property campaigns that fill your pipeline with qualified buyers, sellers, and renters. We target people ready to act, not just browse.',wa:'Real Estate'},
    'Restaurants':{tag:'Food & Beverage Growth',desc:'Mouth-watering visual campaigns + delivery platform ads that drive footfall and online orders. We make your restaurant the go-to spot in your area.',wa:'Restaurant'},
    'Gyms & Fitness':{tag:'Membership Campaigns',desc:'Transformation-story ads that convert casual viewers into long-term paying members. We fill gym floors with motivated people ready to commit.',wa:'Gym & Fitness'},
    'Fashion Boutiques':{tag:'Visual Brand Building',desc:'Style-forward creatives for Instagram & Facebook that drive both in-store traffic and e-commerce sales through stunning brand storytelling.',wa:'Fashion Boutique'},
    'Hotels & Resorts':{tag:'Hospitality Marketing',desc:'Seasonal booking campaigns, loyalty programs, and direct-booking strategies that maximize occupancy and beat OTA commission costs.',wa:'Hotels & Resorts'},
    'Dental Clinics':{tag:'Patient Acquisition',desc:'New patient acquisition campaigns that fill your chair without expensive traditional media. Proven Google Ads results for dentists across India.',wa:'Dental Clinic'},
    'Car Dealerships':{tag:'Automotive Lead Gen',desc:'Test drive bookings, showroom walk-ins, and service appointments through high-intent automotive search and social campaigns.',wa:'Car Dealership'},
    'Jewelry Stores':{tag:'Luxury Showcase Ads',desc:'Premium visual campaigns targeting high-intent buyers during weddings, gifting seasons, and anniversaries. Make your craftsmanship impossible to ignore.',wa:'Jewelry Store'},
    'Salons & Spas':{tag:'Beauty Brand Growth',desc:'Before/after content campaigns and booking funnels that keep your appointment calendar filled weeks in advance with loyal, returning clients.',wa:'Salon & Spa'},
    'Education':{tag:'Enrollment Campaigns',desc:'Student enrollment campaigns targeting parents and students actively searching for the right school, coaching center, or online course.',wa:'Education'},
    'Technology':{tag:'B2B Tech Marketing',desc:'Lead generation that puts your tech services in front of CTO-level decision-makers ready to invest. We generate demos, not just clicks.',wa:'IT & Tech'},
    'Events & Weddings':{tag:'Event Booking Campaigns',desc:'We target couples and families at the exact moment they start planning their big day. Seasonal campaigns with urgency-driven booking funnels.',wa:'Events & Weddings'},
    'General Stores':{tag:'Local Footfall & Discovery',desc:'Google Maps optimization and local discovery campaigns that ensure your community shops with you first — every festival, every season.',wa:'General Store'},
  };
...
(function(){
  ...
  var DB=[
    ...
    /* PRICING */
    {id:'starter-plan',  icon:'💳',title:'Starter Plan — ₹25,000/mo', tag:'Pricing', section:'pricing',            cardLabel:null,
     desc:'1 platform (Google Ads), 5,000+ reach/month, basic analytics, monthly strategy call.',
     keywords:['starter','25k','25000','25','plan','basic','price','pricing','cost','budget','cheap','small','new','entry','low']},
    {id:'growth-plan',   icon:'💳',title:'Growth Plan — ₹30,000/mo',  tag:'Pricing', section:'pricing',            cardLabel:null,
     desc:'Google + Instagram Ads, 15,000+ reach, creative design, bi-weekly strategy calls.',
     keywords:['growth','30k','30000','30','plan','price','pricing','cost','medium','scale','two platform','dual']},
    {id:'business-plan', icon:'💳',title:'Business Plan — ₹40,000/mo',tag:'Pricing', section:'pricing',            cardLabel:null,
     desc:'All 4 platforms, 50,000+ reach, dedicated manager, weekly reports. Most popular choice.',
    ...
    {id:'pricing-page',  icon:'💰',title:'All Pricing Plans',          tag:'Pricing', section:'pricing',            cardLabel:null,
     desc:'Transparent plans from ₹25K/mo — Starter, Growth, Business, and Enterprise with zero hidden charges.',
     keywords:['pricing','plans','price','cost','how much','fees','charge','budget','plan','monthly','package','rupee','all plans']},
...
function openPayModal(planName, amount){
  _payPlan = planName;
  document.getElementById('pay-modal-plan-label').textContent =
...
/* Web fallback URLs opened on desktop */
var _payWebUrls = {
...
/* Called from payment modal buttons */
function triggerUPI(app){
  var deepLink = _buildUPILink(app);
  if(_isMobile){
    /* On mobile: try to open the payment app directly via UPI scheme */
    var a = document.createElement('a');
    a.href = deepLink;
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
    /* Fallback: if still on page after 1.6s, prompt UPI copy */
    setTimeout(function(){
      var btn = document.querySelector('#pay-modal .pay-upi-copy-btn');
      if(btn && btn.textContent === 'Copy'){
        btn.textContent = '📋 Copy UPI ID';
        btn.style.background = 'rgba(37,99,235,0.20)';
        setTimeout(function(){ btn.textContent='Copy'; btn.style.background=''; }, 4000);
      }
    }, 1600);
  } else {
    /* On desktop: open the app's web page in a new tab */
    window.open(_payWebUrls[app] || _payWebUrls.upi, '_blank');
  }
}

/* Called from payment section pay-method cards (no modal context) */
function triggerDirectUPI(app){
  _payPlan = 'UDM Services';
  var deepLink = _buildUPILink(app);
  if(_isMobile){
    var a = document.createElement('a');
    a.href = deepLink;
...
function payModalWhatsApp(){
  var plan = _payPlan || 'your service';
  var msg  = 'Hello, I am interested in the ' + plan + ' plan. Please share more details and help me get started.';
  closePayModal();
  window.open('https://wa.me/919630715686?text=' + encodeURIComponent(msg), '_blank');
}
...
document.addEventListener('keydown', function(e){
  if(e.key === 'Escape'){ closeSvcModal(); closeStatModal(); closePayModal(); }
});
